# find source code: https://medium.com/@cheedellavamsikishore/robotic-path-planning-a-star-96a2c8f9467d
...
def main():
    ...
    # start and goal position  TO BE CHANGED
    sx = 10.0   #[m]
    sy = 45.0   #[m]
    gx = 90.0   #[m]
    gy = 45.0   #[m]
    grid_size = 1.0
    robot_radius = 1.0
    # set obstacle positions TO BE CHANGED
    ox,oy =[],[]
    hx,hy = [],[]
